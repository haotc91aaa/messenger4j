...
public class MessengerPlatformCallbackHandler {
    ...
    private static final String RESOURCE_URL = "https://raw.githubusercontent.com";
    ...
    public ResponseEntity<String> verifyWebhook(@RequestParam(MODE_REQUEST_PARAM_NAME) final String mode,
        ...
        System.out.println(String.format("Received Webhook verification request - mode: {} | verifyToken: {} | challenge: {}", mode, verifyToken, challenge));
        try {
    ...
    public ResponseEntity<Void> handleCallback(@RequestBody final String payload, @RequestHeader(SIGNATURE_HEADER_NAME) final String signature) {
        ...
        System.out.println(String.format("Received Messenger Platform callback - payload: {} | signature: {}", payload, signature));
        try {
    ...
    private void handleTextMessageEvent(TextMessageEvent event) {
        ...
        System.out.println(String.format("Received TextMessageEvent: {}", event));
        ...
        System.out.println(String.format("Received message '{}' with text '{}' from user '{}' at '{}'", messageId, messageText, senderId, timestamp));
    ...
    private void sendUserDetails(String recipientId) throws MessengerApiException, MessengerIOException {
        ...
        System.out.println(String.format("User Profile Picture: {}", userProfile.profilePicture()));
    }
